...
_set_env_from_runtime "QWEN3VL_LOSS_TYPE" "loss_type" "vae+ot+pre_think_mse"
...
_set_env_from_runtime "QWEN3VL_CURRICULUM_LOSS_TYPES" "curriculum_loss_types" "vae+pre_think_mse,vae+pre_think_mse,vae+ot+pre_think_mse"
...
_set_env_from_runtime "QWEN3VL_DEBUG_FORWARD" "debug_forward" "0"
_set_env_from_runtime "QWEN3VL_LOG_HIDDEN_STATES_GRADIENT" "log_hidden_states_gradient" "0"
