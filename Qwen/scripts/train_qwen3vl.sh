...
if [ -z "$CONFIG_PATH" ]; then
    ...
    echo ""
    echo "Examples:"
    echo "  $0 Qwen/configs/qwen3vl_unified_sft.yaml"
    echo "  $0 Qwen/configs/qwen3vl_r1onevision_thinking.yaml ot"
    echo "  $0 Qwen/configs/qwen3vl_r1onevision_thinking.yaml ot+mse"
    echo "  $0 Qwen/configs/qwen3vl_r1onevision_thinking.yaml ot:0.7+mse:0.3"
    echo "  $0 Qwen/configs/qwen3vl_r1onevision_thinking.yaml repa:0.5+nce:0.3+ot:0.2"
    echo ""
