...
from Qwen.evaluation.realworldqa.eval_utils import build_judge, eval_single_sample
...
def main():
    ...
    infer_parser.add_argument("--data-dir", type=str, default=get_data_path("RealWorldQA"),
    ...
    eval_parser.add_argument("--data-dir", type=str, default=get_data_path("RealWorldQA"),
                           help="Path to RealWorldQA data directory")
