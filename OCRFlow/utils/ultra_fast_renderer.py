"""
Ultra-Fast Text Renderer for Training
...
Target: 100+ img/s for batch_size=32
"""
...
class UltraFastRenderer:
    """
    Ultra-fast batch renderer with prefetching.
...
class PrefetchingRenderer:
    ...
    def __init__(
        ...
        self.renderer = UltraFastRenderer(
...
def benchmark_ultra():
    """Benchmark the ultra-fast renderer"""
    print("=" * 70)
    print("UltraFastRenderer Benchmark")
    print("=" * 70)
    ...
    # Warmup
    renderer = UltraFastRenderer(num_workers=8)
