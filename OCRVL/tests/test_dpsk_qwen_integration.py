...
Usage:
    python OCRVL/tests/test_dpsk_qwen_integration.py
"""
...
def test_dpsk_qwen_integration():
    ...
    qwen_model_path = "/share/project/xiyan/huggingface/Qwen/Qwen3-VL-2B-Instruct"
