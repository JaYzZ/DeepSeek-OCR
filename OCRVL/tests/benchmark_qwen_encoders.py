...
Usage:
    python OCRVL/tests/benchmark_qwen_encoders.py
    CUDA_VISIBLE_DEVICES=0 python OCRVL/tests/benchmark_qwen_encoders.py
"""
...
from OCRVL.encoder import Qwen3VLEncoder, Qwen25VLEncoder
